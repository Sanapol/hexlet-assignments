...
public class ProductsController {
    ...
    public ProductDTO update(@RequestBody ProductUpdateDTO productData, @PathVariable long id) {
        ...
        Product update = toUpdate(productData, product);
        productRepository.save(update);
        ProductDTO productDTO = toDTO(update);
        return productDTO;
    }

    private Product toUpdate(ProductUpdateDTO productUpdateDTO, Product product) {
